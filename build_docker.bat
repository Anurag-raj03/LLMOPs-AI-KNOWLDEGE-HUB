@echo off
REM Docker Build Script for AIops Project
REM Run this script to rebuild your Docker containers with fixed dependencies
...
echo Step 2: Removing old images (optional - press Ctrl+C to skip)...
pause
